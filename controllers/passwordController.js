...
@access Public
*/
module.exports.getForgotPasswordView = asyncHandler(
(req,res)=>{
res.render("forget-password");
//rendering the view html if js we use json
//API we use json,MVC we use render  
});
...
@access Public
 */
module.exports.ResetThePassword = asyncHandler(
async(req,res)=>{
